...
## fasta_iter
#
#	modified from code written by brentp and retrieved from
#       https://www.biostars.org/p/710/ on May 5, 2015
...
def revcomp(seq):
    #TODO fix line length
	tbl={"T":"A","C":"G","G":"C","A":"T","U":"A","R":"Y","Y":"R","S":"S","W":"W","K":"M","M":"K","B":"V","V":"B","D":"H","H":"D","N":"N","-":"-","*":"*"}
	fwd=''
	for i in seq:
		fwd+=tbl[i]
	return fwd[::-1]
