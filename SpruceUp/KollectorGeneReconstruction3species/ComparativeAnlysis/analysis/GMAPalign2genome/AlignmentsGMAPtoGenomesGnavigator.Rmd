---
title: "GMAP alignments for 3 species - cdhit4 with Gnavigator parameters GMAP"
...
```{r plots_multiple_alignments_gnavig}
...
```{r intersect_KollectorCommon_gnavig}
