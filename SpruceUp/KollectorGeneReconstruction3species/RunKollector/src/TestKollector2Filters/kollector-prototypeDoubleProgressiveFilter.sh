...
#Description: 2 step filtering progressive - B, filtered reads 
...
base_dir=/extscratch/btl/kgagalova/trial_kollectorImproved/FilteredReadsDoubleFilterProgressive
...
biobloommaker -i -k $K -p ${nam_bbt}tar -f 0.001 -t $j -n $n1 -s $rep_fil -r $r ${nam_bbt}tar.fa $READS_B1_R1 $READS_B1_R2
