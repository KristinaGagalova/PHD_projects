...
#Description: Simple targets filter - A, all reads
...
base_dir=/extscratch/btl/kgagalova/trial_kollectorImproved/FilteredReadsSingleFilter
...
biobloomcategorizer -i -t $j -d PrototypeB0 -f /extscratch/btl/kgagalova/trial_kollectorImproved/FilteredReadsProgressive/PrototypeB0.bf -s 0.7 /extscratch/btl/kgagalova/trial_kollectorAbyssSparamNormTEST/RecrutedReads/read_1.fastq /extscratch/btl/kgagalova/trial_kollectorAbyssSparamNormTEST/RecrutedReads/read_2.fastq >> PrototypeB0.fastq

mkdir -p $abyss_dir
abyss-pe -C $abyss_dir v=-v k=$k name=$nam_bbt np=$j lib='pet' pet=../PrototypeB0.fastq long='longlib' longlib=$TARGETS B=18G H=4 kc=3
